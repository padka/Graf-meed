...
var ReferenceInput = function (props) {
    var _a = props.children, children = _a === void 0 ? defaultChildren : _a, reference = props.reference, _b = props.sort, sort = _b === void 0 ? { field: 'id', order: 'DESC' } : _b, _c = props.filter, filter = _c === void 0 ? {} : _c;
    var controllerProps = (0, ra_core_1.useReferenceInputController)(__assign(__assign({}, props), { sort: sort, filter: filter }));
    if (props.validate) {
...
var defaultChildren = react_1.default.createElement(AutocompleteInput_1.AutocompleteInput, null);
